import { AlertCircle, AlertCircleIcon, Hash, HashIcon, LockIcon, UserIcon, XIcon } from "lucide-react";
...
const CreateChannelModal = ({ onClose }) => {
  ...
  const [users, setUsers] = useState([]); // list of users to add to the channel
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (channelType === "private") {
        ...
        channelData.visiblitity = "private";
      } else {
        channelData.visibility = "public";
        channelData.discovarable = true;
      }
      ...
      toast.error(`Failed to create channel ${channelName}`);
    } finally {
      setIsCreating(false);
    }
  }
  ...
  return (
    <div className="create-channel-modal-overlay">
      <div className="create-channel-modal">
        ...
        {/* form  */}
        <form action="" onSubmit={handleSubmit} className="create-channel-modal__form">
          {error && (
